        ...
        <div id="rc-imageselect" class="gc-size-wrap">
          <div id="rc-imageselect">
            ...
            <div class="rc-imageselect-payload">
              ...
              <div class="rc-imageselect-incorrect-response" v-show="errorCode=='rc-imageselect-incorrect-response'">请重试。</div>
              <div class="rc-imageselect-error-select-more" v-show="errorCode=='rc-imageselect-error-select-more'">请选择所有相符的图片。</div>
            </div>
            <div class="rc-footer">
...
const object_names = ['公交车', '消防栓', '烟囱', '飞机']
